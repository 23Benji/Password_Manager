...
#define VERSION "1.0" // Version of the program
...
int about_developer(void){
    ...
    printf("This Password Manager was created by Me, "YEL"Benji"reset".\n");
    printf("I am a 17 year old student from "YEL"Bolzano, Italy"reset", studing since 2023 in the "YEL"TFO-Max Valier"reset" Highschool.\n");
